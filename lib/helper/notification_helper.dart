...
import 'package:craft_discount_liquors/common/enums/notification_type.dart';
...
import 'package:craft_discount_liquors/common/widgets/notification_dialog_web_widget.dart';
      ...
      showDialog(
        ...
        builder: (context) => Center(
          child: NotificationDialogWebWidget(
            notification: NotificationBody.fromJson(message.data),
          ),
        ),
      );
