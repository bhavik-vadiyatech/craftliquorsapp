...
import 'package:craft_discount_liquors/features/refer_and_earn/helper/refer_helper.dart';
                  ...
                  InkWell(
                    ...
                    onTap: () => SharePlus.instance.share(
                      ShareParams(
                        ...
                        uri: Uri.tryParse(
                          '${AppConstants.webHostUrl}${RouteHelper.createAccount}?referral_code=${profileProvider.userInfoModel?.referCode ?? ''}',
                        ),
                      ),
                    ),
                    child: Container(
