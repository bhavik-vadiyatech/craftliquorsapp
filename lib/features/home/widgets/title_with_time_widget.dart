...
class TitleWithTimeWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isFlashDealScreen = GoRouter.of(
      context,
    ).state.uri.toString().contains(ProductType.flashSale);
      ...
      child: Consumer<FlashDealProvider>(
        builder: (context, flashDealProvider, _) {
          return flashDealProvider.flashDealModel != null
              ? ResponsiveHelper.isDesktop(context) && !isDetailsPage!
                    ? Column(
                        children: [
