...
import 'package:craft_discount_liquors/features/order_track/screens/track_map_screen_web.dart';
import 'package:craft_discount_liquors/features/order_track/widgets/location_timeline_widget.dart';
import 'package:craft_discount_liquors/features/order_track/widgets/track_map_deliveryman_info.dart';
...
class _TrackMapScreenState extends State<TrackMapScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      /// Get bottom sheet Min height
      _animateCameraWithDragBottomSheet();

      /// Expand or minimize bottom sheet with auto movement camera position
    });
    Future.microtask(
      () => _trackerProvider?.getDeliveryManData(
        ...
        appBar:
            (ResponsiveHelper.isDesktop(context)
                    ...
                    : CustomAppBarWidget(
                        ...
                        subTitle: RichText(
                          text: TextSpan(
                            text: getTranslated('your_delivery_is', context),
                ...
                : Stack(
                    children: [
                      ...
                      DraggableScrollableSheet(
                        ...
                        initialChildSize: _bottomSheetMinSize,
                        minChildSize: _bottomSheetMinSize,
                        maxChildSize: _bottomSheetMaxSize,
                        snap: true,
                        builder: (context, scrollController) {
                          return Container(
                            ...
                            margin: const EdgeInsets.only(
                              left: 15,
                              right: 15,
                              bottom: _bottomSheetBottomMargin,
                            ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TrackMapDeliverymanInfo(
                                      key: _minContentKey,
                                      deliveryMan: widget.order?.deliveryMan,
