...
import 'package:craft_discount_liquors/features/product/widgets/product_description_widget.dart';
import 'package:craft_discount_liquors/features/product/widgets/product_image_widget.dart';
import 'package:craft_discount_liquors/features/product/widgets/product_title_widget.dart';
import 'package:craft_discount_liquors/features/product/widgets/quantity_button_widget.dart';
import 'package:craft_discount_liquors/features/product/widgets/selected_product_widget.dart';
import 'package:craft_discount_liquors/features/product/widgets/variation_widget.dart';
import 'package:craft_discount_liquors/features/splash/providers/splash_provider.dart';
import 'package:craft_discount_liquors/helper/cart_helper.dart';
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen>
  ...
  void initState() {
    ...
    productProvider
        ...
        .then((_) {
          if (isHtmlContentEmpty(productProvider.product?.description)) {
            _tabIndex = 1;
    ...
    productProvider.getProductReviews(
      id: widget.productId,
      offset: 1,
      isUpdate: false,
    );
                ...
                if (productProvider.product != null) {
                  ...
                  if (cartProvider.cartIndex != null) {
                    priceWithQuantity =
                        (priceWithDiscount ?? 0) *
                        (cartProvider
                            .updatedCartList[cartProvider.cartIndex!]
                            .quantity!);
                    ...
                    priceWithQuantityWithoutDiscount =
                        (cartModel?.price ?? 0) * cartProvider.quantity;
                  }
                }
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            '${cartProvider.cartIndex != null ? cartProvider.updatedCartList[cartProvider.cartIndex!].quantity : cartProvider.quantity}',
                                                            style: poppinsBold
                                                                .copyWith(
                                                                  color: Theme.of(
                                                                    context,
                                                ...
                                                child: SingleChildScrollView(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      if (priceWithQuantityWithoutDiscount >
                                                          priceWithQuantity)
                                                        Text(
                                                          "Save ${PriceConverterHelper.convertPrice(context, priceWithQuantityWithoutDiscount - priceWithQuantity)} on this item",
                                                                        ...
                                                                        builder:
                                                                            (
                                                                              ...
                                                                              return Text(
                                                                                cart.cartIndex !=
                                                                                        null
                                                                                    ? cart.updatedCartList[cart.cartIndex!].quantity.toString()
  ...
  VoidCallback? _onSubmitCartButton(
    CartProvider cartProvider,
    CartModel? cartModel,
    BuildContext context,
  ) {
    return ((cartProvider.pendingCartList.isNotEmpty ||
