...
import 'package:craft_discount_liquors/common/widgets/custom_ink_well_widget.dart';
            ...
            children: [
              PageView.builder(
                ...
                itemBuilder: (context, index) {
                  String image =
                      '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.reviewImageUrl}/${widget.images[index]}';
                  return PhotoView(
