...
import 'package:craft_discount_liquors/features/menu/screens/main_screen.dart';
import 'package:craft_discount_liquors/features/menu/widgets/menu_list_web_widget.dart';
import 'package:craft_discount_liquors/features/menu/widgets/custom_drawer_widget.dart';
...
class MenuWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isDarkOrDesktop =
        Provider.of<ThemeProvider>(context).darkTheme ||
        ResponsiveHelper.isDesktop(context);

    return Scaffold(
      backgroundColor: isDarkOrDesktop
      ...
      appBar: ResponsiveHelper.isDesktop(context)
          ...
          : null,
      body: Container(
        decoration: isDarkOrDesktop
            ? null
            : const BoxDecoration(
                gradient: LinearGradient(
                  colors: [Color(0xFFD90402), Color(0xFF130303)],
                        ...
                        return Column(
                          children: [
                            ...
                            if (!ResponsiveHelper.isDesktop(context))
                              Column(
                                children: splashProvider.screenList
                                    .map(
