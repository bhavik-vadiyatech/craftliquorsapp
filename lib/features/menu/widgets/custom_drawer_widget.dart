...
class _CustomDrawerWidgetState extends State<CustomDrawerWidget>
  ...
  final Curve _slideInCurve = const Interval(
    0.0,
    1.0,
  ...
  Widget _zoomAndSlideContent(
    ...
    switch (_state) {
      ...
      case DrawerState.opening:
        slidePercent = (widget.openCurve ?? _slideOutCurve).transform(
          _percentOpen,
        );
        scalePercent = _scaleDownCurve.transform(_percentOpen);
        break;
      case DrawerState.closing:
        slidePercent = (widget.closeCurve ?? _slideInCurve).transform(
          _percentOpen,
        );
      ...
      children: [
        ...
        if (widget.showShadow) ...[
          ...
          AnimatedBuilder(
            ...
            child: Container(color: widget.backgroundColor.withAlpha(31)),
          ),
