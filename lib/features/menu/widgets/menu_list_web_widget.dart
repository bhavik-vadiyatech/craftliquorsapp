  ...
  Widget build(BuildContext context) {
    ...
    final List<MenuModel> menuList = [
      ...
      MenuModel(
        ...
        route: () => RouteHelper.getOrderSearchRoute(),
      ),
      MenuModel(
      ...
      if (splashProvider.configModel!.loyaltyPointStatus!)
        MenuModel(
          ...
          route: () => RouteHelper.getLoyaltyScreen(),
        ),
