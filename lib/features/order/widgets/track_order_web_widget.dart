                ...
                children: [
                      ...
                      CustomDirectionalityWidget(
                        child: Text(
                          PriceConverterHelper.convertPrice(
                            context,
                            orderProvider.trackModel!.orderAmount,
                          ),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          if (OrderHelper.isShowDeliveryAddress(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  ConstrainedBox(
                                    ...
                                    child: Text(
                                      orderProvider.trackModel?.orderType ==
                                              'take_away'
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      if (isOrderFailed)
                        CustomStepperWidget(
                          height: orderProvider.trackModel?.deliveryMan == null
                              ? 30
                              : 130,
                          ...
                          color: status == OrderConstants.failed
                        ...
                        Consumer<LocationProvider>(
                          builder: (context, locationProvider, _) {
                            return CustomStepperWidget(
                              ...
                              height:
                                  orderProvider.deliveryManModel != null &&
                                      (config?.googleMapStatus ?? false)
                                  ? 145
                                  : 30,
                              child:
