        ...
        return Opacity(
          ...
          child: Column(
            children: [
              if (checkoutProvider.showBringChangeInputOption)
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "${getTranslated("change_amount", context)} (${configModel.currencySymbol})",
                      ...
                      Text(
                        getTranslated("bring_cash_hint_text", context),
                        style: poppinsRegular.copyWith(
                          overflow: TextOverflow.ellipsis,
              ...
              TextButton(
                onPressed: widget.hidePaymentMethod
                    ? null
                    : () {
                        checkoutProvider.updateBringChangeInputOptionStatus(
                          !checkoutProvider.showBringChangeInputOption,
                        );
                      },
                style: ButtonStyle(
                ...
                child: Padding(
                  ...
                  child: Text(
                    checkoutProvider.showBringChangeInputOption
                        ? getTranslated("see_less_minus", context)
                        : getTranslated("see_more_plus", context),
                    style: poppinsRegular.copyWith(
