...
import 'package:craft_discount_liquors/features/order/widgets/re_order_dialog_widget.dart';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: OrderStatus.pending.name == orderList![index].orderStatus
            ? ColorResources.colorBlue.withValues(alpha: 0.08)
            : OrderStatus.outForDelivery.name == orderList![index].orderStatus
            ? ColorResources.ratingColor.withValues(alpha: 0.08)
            : OrderStatus.canceled.name == orderList![index].orderStatus
            ? ColorResources.redColor.withValues(alpha: 0.08)
            : ColorResources.colorGreen.withValues(alpha: 0.08),
        borderRadius: BorderRadius.circular(Dimensions.radiusSizeTen),
      ),
      child: Text(
