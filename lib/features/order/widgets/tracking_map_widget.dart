...
//         ? LatLng(widget.deliveryManModel?.latitude ?? 0, widget.deliveryManModel?.longitude ?? 0) : const LatLng(0, 0);
//     _addressLatLng = widget.addressModel != null ? LatLng(widget.addressModel!.latitude!, widget.addressModel!.longitude! ) : const LatLng(0,0);
