...
import 'package:craft_discount_liquors/common/widgets/custom_alert_dialog_widget.dart';
...
import 'package:craft_discount_liquors/common/widgets/custom_zoom_widget.dart';
import 'package:craft_discount_liquors/features/checkout/widgets/offline_payment_widget.dart';
import 'package:craft_discount_liquors/features/checkout/widgets/payment_method_bottom_sheet_widget.dart';
...
import 'package:craft_discount_liquors/features/order/widgets/payment_info_widget.dart';
import 'package:craft_discount_liquors/features/order/widgets/switch_payment_confirmation_widget.dart';
...
import 'package:craft_discount_liquors/features/order/widgets/ordered_product_list_widget.dart';
      ...
      builder: (context, orderProvider, _) {
        ...
        return Column(
          ...
          children: [
                                    ...
                                    color:
                                        OrderStatus.pending.name ==
                                            orderProvider
                                                .trackModel!
                                                .orderStatus
                                        ? ColorResources.colorBlue.withValues(
                                            alpha: 0.08,
                                          )
                                        : OrderStatus.outForDelivery.name ==
                                              orderProvider
                                                  .trackModel!
                                                  .orderStatus
                                        ? ColorResources.ratingColor.withValues(
                                            alpha: 0.08,
                                          )
                                        : OrderStatus.canceled.name ==
                                              orderProvider
                                                  .trackModel!
                                                  .orderStatus
                                        ? ColorResources.redColor.withValues(
                                            alpha: 0.08,
                                          )
                                        : ColorResources.colorGreen.withValues(
                                            alpha: 0.08,
                                          ),
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          if (orderProvider.trackModel!.orderType ==
                                  'delivery' &&
                            ...
                            InkWell(
                              onTap: () {
                                if (orderProvider.trackModel!.deliveryAddress !=
                                    null) {
                                  RouteHelper.getOrderMapInfoRoute(
                                    orderProvider.trackModel!.deliveryAddress,
                                  );
                                } else {
            ...
            if (orderProvider.trackModel!.offlinePayment != null &&
                orderProvider.trackModel!.offlinePayment?.status == 2 &&
                orderProvider.trackModel?.paymentMethod == "offline_payment")
              _OfflinePaymentDeniedNoteWidget(
                offlinePayment: orderProvider.trackModel!.offlinePayment!,
              ),
              ...
              child:
                  ...
                  : Column(
                      ...
                      children: [
                        ...
                        if (orderProvider.trackModel?.paymentMethod ==
                                'cash_on_delivery' &&
                            orderProvider.trackModel!.bringChangeAmount !=
                                null &&
                            orderProvider.trackModel!.bringChangeAmount! > 0)
                          Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        ...
                                        TextSpan(
                                          text:
                                              " ${PriceConverterHelper.convertPrice(context, orderProvider.trackModel!.bringChangeAmount!)} ",
                                          style: poppinsSemiBold,
                                        ),
                                        TextSpan(
                                          text: getTranslated(
                                            'in_change_when_making_the_delivery',
                                            context,
                                          ),
                                          style: poppinsRegular.copyWith(
                                            fontSize:
                ...
                ? Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          orderProvider.trackModel?.orderNote ?? '',
                          style: poppinsRegular.copyWith(
        ...
        : Column(
            ...
            children: [
                ...
                children: [
                  ...
                  if (orderModel?.paymentStatus == "paid" ||
                    ...
                    InkWell(
                      ...
                      child: Text(
                        getTranslated("see_details", context),
              ...
              Row(
                ...
                children: [
                  Text(
                    "${getTranslated('payment_name', context)} : ${orderModel?.offlinePaymentInformation?.paymentName ?? ""}",
                    style: poppinsRegular,
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                  ),
                            ...
                            onPressed: () {
                              if (configModel?.cashOnDelivery ?? false) {
                                showDialog(
                                  ...
                                  builder: (context) =>
                                      SwitchPaymentConfirmationWidget(
                                        orderID:
                                ...
                                showCustomSnackBarHelper(
                                  getTranslated(
                                    'payment_method_unavailable_talk_to_admin',
                                    context,
                                  ),
                                );
                              }
                            ...
                            onPressed: () {
                              ResponsiveHelper().showDialogOrBottomSheet(
                                ...
                                OfflinePaymentWidget(
                                  ...
                                  orderOfflineData:
                                      orderModel?.offlinePaymentInformation,
                                  partialAmount: null,
...
class _IncompleteOfflinePayment extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool isPartialPayment =
        ...
        (orderModel?.orderPartialPayments?.isNotEmpty ?? false);
          ...
          children: [
            ...
            SizedBox(
              ...
              child: CustomButtonWidget(
                ...
                onPressed: orderModel?.orderStatus != "pending"
                    ? null
                    : () {
                        ResponsiveHelper().showDialogOrBottomSheet(
                          context,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            '# ${getTranslated('denied_note', context)}',
            style: poppinsSemiBold.copyWith(
              fontSize: Dimensions.fontSizeLarge,
              color: Theme.of(context).colorScheme.error,
            ),
