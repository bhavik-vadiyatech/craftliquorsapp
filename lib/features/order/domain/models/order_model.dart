...
class OrderModel {
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    _orderPartialPayments = json["partial_payment"] == null
        ? []
        : List<OrderPartialPayment>.from(
            json["partial_payment"]!.map((x) => OrderPartialPayment.fromMap(x)),
          );
    ...
    _weightChargeAmount = double.tryParse(
      json['weight_charge_amount'].toString(),
    );
    _bringChangeAmount = double.tryParse(
      json['bring_change_amount'].toString(),
    );
...
class OrderImage {
  ...
  factory OrderImage.fromMap(Map<String, dynamic> json) =>
      OrderImage(image: json["image"]);
