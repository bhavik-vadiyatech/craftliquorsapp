                      ...
                      builder: (context, verificationProvider, child) => Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Image.asset(
                              isPhone
                                  ? Images.phoneVerificationBackgroundIcon
                                  : Images.emailVerificationBackgroundIcon,
                              width: 142,
                              height: 142,
                            ...
                            Consumer<AuthProvider>(
                              builder: (context, authProvider, _) {
                                ...
                                Duration duration = Duration(
                                  seconds:
                                      verificationProvider.currentTime ?? 0,
                                );
                                              ...
                                              child: CustomButtonWidget(
                                                ...
                                                onPressed: () {
                                                  if (widget.fromPage ==
                                                      FromPage.otp.name) {
                                                    if (isPhone &&
                                                        AuthHelper.isFirebaseVerificationEnable(
                                                          config,
                                                        )) {
                                                      authProvider.firebaseOtpLogin(
                                                        ...
                                                        AuthHelper.isPhoneVerificationEnable(
                                                          config,
                                                        )) {
                                                      verificationProvider.verifyPhoneForOtp(userInput).then((
                                                        value,
                                                      ) {
                                                        final (
                                                          responseModel,
                                                        ...
                                                        if ((responseModel !=
                                                          ...
                                                          if (authProvider
                                                            ...
                                                            String
                                                            userCountryCode =
                                                                PhoneNumberCheckerHelper.getCountryCode(
                                                                  userInput,
                                                                )!;
                                                      ...
                                                      FromPage.login.name) {
                                                    if (AuthHelper.isCustomerVerificationEnable(
                                                      config,
                                                    )) {
                                                      if (isPhone &&
                                                          isFirebaseOTP) {
                                                        ...
                                                        verificationProvider.verifyPhone(userInput.trim()).then((
                                                          value,
                                                        ) {
                                                          if (value.isSuccess) {
                                                            if (authProvider
                                                          ...
                                                          AuthHelper.isEmailVerificationEnable(
                                                            config,
                                                          )) {
                                                        verificationProvider.verifyEmail(userInput).then((
                                                          value,
                                                        ) {
                                                          if (value.isSuccess) {
                                                            if (authProvider
