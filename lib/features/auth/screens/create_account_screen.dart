...
import 'package:craft_discount_liquors/features/auth/domain/models/signup_model.dart';
...
class _FromWidget extends StatelessWidget {
  ...
  const _FromWidget({required this.authProvider, required this.config});
    ...
    return Column(
      ...
      children: [
        ...
        CustomTextFieldWidget(
          ...
          hintText: 'John',
          isShowBorder: true,
          controller: createAccountState?._firstNameController,
          focusNode: createAccountState?._firstNameFocus,
          nextFocus: createAccountState?._lastNameFocus,
        ...
        CustomTextFieldWidget(
          ...
          hintText: 'Doe',
          isShowBorder: true,
          controller: createAccountState?._lastNameController,
          focusNode: createAccountState?._lastNameFocus,
          nextFocus: createAccountState?._emailFocus,
          inputType: TextInputType.name,
          capitalization: TextCapitalization.words,
        ),
        const SizedBox(height: Dimensions.paddingSizeLarge),
        ...
        // for phone section
        CustomTextFieldWidget(
          countryDialCode: createAccountState?.countryCode,
          onCountryChanged: (CountryCode value) {
            createAccountState?.countryCode = value.dialCode;
          },
          hintText: getTranslated('number_hint', context),
          isShowBorder: true,
          controller: createAccountState?._numberController,
        ...
        CustomTextFieldWidget(
          ...
          isShowBorder: true,
          isPassword: true,
          controller: createAccountState?._passwordController,
          focusNode: createAccountState?._passwordFocus,
          nextFocus: createAccountState?._confirmPasswordFocus,
        ...
        CustomTextFieldWidget(
          ...
          isShowBorder: true,
          isPassword: true,
          controller: createAccountState?._confirmPasswordController,
          focusNode: createAccountState?._confirmPasswordFocus,
          isShowSuffixIcon: true,
