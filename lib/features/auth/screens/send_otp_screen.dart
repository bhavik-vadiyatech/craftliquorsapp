...
import 'package:craft_discount_liquors/features/auth/widgets/social_login_widget.dart';
                                        ...
                                        child: Column(
                                          children: [
                                                        ...
                                                        if (_phoneNumberController!
                                                          ...
                                                          phoneWithCountryCode =
                                                              ...
                                                              _phoneNumberController!
                                                                  .text
                                                                  .trim();
                                                          if (PhoneNumberCheckerHelper.isPhoneValidWithCountryCode(
                                                            phoneWithCountryCode,
                                                          )) {
                                            ...
                                            if (AuthHelper.isSocialMediaLoginEnable(
                                                ...
                                                !AuthHelper.isManualLoginEnable(
                                                  configModel,
                                                )) ...[
                                              Center(
                                                child: Text(
