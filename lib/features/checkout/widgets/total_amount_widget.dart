...
import 'package:craft_discount_liquors/features/checkout/widgets/shipping_policy_bottom_sheet.dart';
...
String _toolTipMessage(BuildContext context) {
  ...
  message += getTranslated(
    '${splashProvider.deliveryInfoModelList?[orderProvider.branchIndex].deliveryChargeSetup?.deliveryChargeType}',
    context,
  );

  if (splashProvider
          .deliveryInfoModelList?[orderProvider.branchIndex]
          .deliveryWeightSettingsStatus ??
      false) {
