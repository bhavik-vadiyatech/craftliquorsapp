...
import 'package:craft_discount_liquors/features/order/widgets/bring_change_input_widget.dart';
...
import 'package:craft_discount_liquors/features/checkout/widgets/payment_button_widget.dart';
...
class _PaymentMethodBottomSheetWidgetState
                  ...
                  child: SafeArea(
                    child: Consumer<OrderProvider>(
                      builder: (ctx, orderProvider, _) {
                        ...
                        bool isWalletSelectAndNotPartial =
                            _paymentMethodIndex == 0 && !isPartialPayment;

                        bool hideCOD =
                            isWalletSelectAndNotPartial ||
                            (_partialAmount != null &&
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            Text(
                              getTranslated('total_bill', context),
                            ...
                            PriceConverterHelper.convertAnimationPrice(
                              context,
                              widget.totalPrice,
                                  ...
                                  child: Column(
                                    children: [
                                      configModel.walletStatus! &&
                                              ...
                                              walletBalance > 0 &&
                                              !widget.isAlreadyPartialApplied
                                          ? PaymentButtonWidget(
                                                  ...
                                                  ({
                                                    ...
                                                    setState(() {
                                                      ...
                                                      _partialAmount =
                                                          partialAmount;
                                                      _paymentMethod = null;
                                                      _bringAmountController
                                                              ?.text =
                                                          "";
                                                      orderProvider
                                                          .updateBringChangeInputOptionStatus(
                                                            false,
                                                            isUpdate: false,
                                                          );
                                                      orderProvider
                                                          .setBringChangeAmount();
                                                    });
                                                  },
                                            )
                                          : const SizedBox(),
                                                  ...
                                                  ({
                                                    ...
                                                    setState(() {
                                                      _paymentMethodIndex =
                                                          paymentMethodIndex;
                                                      _paymentMethod = null;
                                                      _selectedOfflineValue =
                                                          null;
                                                      _selectedOfflineMethod =
                                                          null;
                                                    });
                                                  },
                                            )
                                      ...
                                      if (paymentList.isNotEmpty)
                                        Opacity(
                                          opacity: (hideOffline && hideDigital)
                                              ? 0.4
                                              : 1,
                                          child: Stack(
                                            children: [
  ...
  void initState() {
    ...
    partialPaymentCombinator =
        configModel.partialPaymentCombineWith?.toLowerCase() ?? "all";
  ...
  void _initializeData() {
    ...
    if (orderProvider.paymentMethodIndex != 1) {
      ...
      _bringAmountController?.text = "${orderProvider.bringChangeAmount ?? ""}";
    }
  }

  void _placeOfflineOrder({
    ...
    final bool isSelfPickup = CheckOutHelper.isSelfPickup(
    ...
    List<CartModel> cartList = Provider.of<CartProvider>(
      context,
      listen: false,
    ).cartList;
    List<Cart> carts = [];
    ...
    if (isSuccess) {
      ...
      ResponsiveHelper().showDialogOrBottomSheet(
        ...
        OfflinePaymentWidget(
          ...
          partialAmount: isPartialPayment && _partialAmount != null
              ? (widget.totalPrice - walletBalance)
              : widget.totalPrice,
          orderId: orderID,
          fromCheckout: true,
  ...
  Future<void> _switchOfflineToDigital({
    ...
    final paymentUrl = await orderProvider.placeDigitalOrder(
      context,
      placeOrderBody,
    );
