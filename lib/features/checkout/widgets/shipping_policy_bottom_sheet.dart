...
class ShippingPolicyBottomSheet extends StatelessWidget {
  const ShippingPolicyBottomSheet({super.key});

  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.all(
        ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeDefault : 0,
      ),
      child: Column(
        ...
        children: [
          ...
          Text(
            getTranslated('shipping_policy_rules', context),
          ...
          Text(
            getTranslated('delivery_charge_calculation_based_on', context),
            maxLines: 2,
          ...
          Row(
            children: [
              ...
              Text(
                getTranslated('fixed_wise', context),
                style: poppinsRegular.copyWith(
          ...
          Row(
            children: [
              ...
              Text(
                getTranslated('distance_wise', context),
                style: poppinsRegular.copyWith(
                  fontSize: Dimensions.fontSizeDefault,
                ),
              ),
          ...
          Row(
            children: [
              ...
              Text(
                getTranslated('postcode_area_wise', context),
                style: poppinsRegular.copyWith(
                  fontSize: Dimensions.fontSizeDefault,
                ),
              ),
          ...
          Row(
            children: [
              ...
              Text(
                getTranslated('extra_charge_on_weight', context),
                style: poppinsRegular.copyWith(
                  fontSize: Dimensions.fontSizeDefault,
                ),
              ),
          ...
          Text(
            getTranslated(
              'entering_location_postcode_result_estimated_delivery_time',
              context,
            ),
            style: poppinsRegular.copyWith(
              color: Theme.of(context).textTheme.bodyMedium?.color,
