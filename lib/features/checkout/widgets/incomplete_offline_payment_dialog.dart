...
import 'package:craft_discount_liquors/features/order/widgets/order_cancel_widget.dart';
...
class _IncompleteOfflinePaymentDialogState
  ...
  void initState() {
    ...
    Provider.of<OrderProvider>(
      context,
      listen: false,
    ).setLastIncompleteOfflineBookingId(widget.order?.id ?? 0);
  }
  ...
  Widget build(BuildContext context) {
    ...
    bool isPartialPayment =
        widget.order?.orderPartialPayments != null &&
        (widget.order?.orderPartialPayments?.isNotEmpty ?? false);
    ...
    return Container(
      ...
      child: Consumer<OrderProvider>(
        builder: (ctx, orderProvider, _) {
          return SizedBox(
            width: Dimensions.webScreenWidth / 2.5,
            child: Stack(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          getTranslated("your_payment_was_incomplete", context),
                      ...
                      Padding(
                        ...
                        child: Text(
                          getTranslated(
                            "your_payment_was_incomplete_please_pay",
                            context,
                          ),
                        ...
                        onPressed: () {
                          ...
                          ResponsiveHelper().showDialogOrBottomSheet(
                            ...
                            PaymentMethodBottomSheetWidget(
                              totalPrice:
                                  dueAmount ?? widget.order?.orderAmount ?? 0,
                      ...
                      configModel?.cashOnDelivery != false
                          ? TextButton(
                              onPressed: () async {
                                Navigator.of(context).pop();
                              ...
                              child: Text(
                                getTranslated('switch_to_cas', context),
                                textAlign: TextAlign.center,
                                style: poppinsMedium.copyWith(
                                  color: Theme.of(
                                    context,
                      ...
                      SizedBox(
                        height: configModel?.cashOnDelivery != false
