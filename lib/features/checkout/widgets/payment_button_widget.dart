...
class PaymentButtonWidget extends StatelessWidget {
  ...
  final void Function({int? paymentMethodIndex, double? partialAmount})
  callBack;
  const PaymentButtonWidget({
    ...
    required this.hidePaymentMethod,
    this.partialAmount,
    required this.chooseAnyPayment,
  ...
  Widget build(BuildContext context) {
    return Consumer<OrderProvider>(
      builder: (ctx, checkoutProvider, _) {
        ...
        bool isWalletPaymentApplied = isPartialPayment
            ? (partialAmount != null)
            : isSelected;
        double paidAmount = (isPartialPayment ? walletBalance : totalPrice);
        double remainingWalletBalance = isPartialPayment
            ? 0
                ...
                children: [
                  ...
                  if (isPartialPayment &&
                    ...
                    Padding(
                      ...
                      child: Text(
                        getTranslated("pay_the_rest_amount_hint", context),
                        style: poppinsRegular.copyWith(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                getTranslated('paid_by_wallet', context),
          ...
          if (isPartialPayment)
            Row(
              ...
              children: [
                Text(
                  getTranslated('remaining_bill', context),
                  style: poppinsMedium,
                ),
                PriceConverterHelper.convertAnimationPrice(
                  context,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    (walletPaymentStatus
                        ? getTranslated("wallet_remaining_balance", context)
                        : getTranslated("wallet_balance", context)),
                    style: poppinsRegular.copyWith(
                      overflow: TextOverflow.ellipsis,
