...
import 'package:craft_discount_liquors/features/address/widgets/map_with_lable_widget.dart';
...
import 'package:craft_discount_liquors/common/widgets/phone_number_field_widget.dart';
import 'package:craft_discount_liquors/features/address/widgets/add_address_widget.dart';
    ...
    return Container(
      decoration: ResponsiveHelper.isDesktop(context)
          ? BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: ColorResources.cartShadowColor.withValues(alpha: 0.2),
                  blurRadius: 10,
                ),
              ],
            )
        ...
        child: Column(
          ...
          children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      '${getTranslated('floor', context)} ${getTranslated('number', context)}',
                                      style: poppinsMedium.copyWith(
                                        color: Theme.of(
                                          context,
                                        ).textTheme.bodyMedium?.color,
            ...
            if (!ResponsiveHelper.isDesktop(context)) ...[
              ...
              _AddressLabelAsWidget(locationProvider: locationProvider),
...
class _AddressLabelAsWidget extends StatelessWidget {
  final LocationProvider locationProvider;
  const _AddressLabelAsWidget({required this.locationProvider});
