...
import 'package:craft_discount_liquors/helper/address_helper.dart';
...
import 'package:craft_discount_liquors/features/address/widgets/search_dialog_widget.dart';
      ...
      _initialPosition = LatLng(
        double.parse(
          Provider.of<SplashProvider>(
            context,
            listen: false,
          ).configModel!.branches![0].latitude!,
        ),
        double.parse(
          Provider.of<SplashProvider>(
            context,
            listen: false,
          ).configModel!.branches![0].longitude!,
        ),
      );
    } else {
      _initialPosition = LatLng(
                          ...
                          child: Padding(
                            ...
                            child: CustomButtonWidget(
                              ...
                              onPressed: locationProvider.loading
                                  ? null
                                  : () {
                                      if (locationProvider.pickAddress !=
                                          null) {
