...
import 'package:craft_discount_liquors/features/wallet_and_loyalty/widgets/convert_money_widget.dart';
import 'package:craft_discount_liquors/features/wallet_and_loyalty/widgets/history_widget.dart';
import 'package:craft_discount_liquors/features/wallet_and_loyalty/widgets/tab_button_widget.dart';
        ...
        child: Scaffold(
          ...
          body: Consumer<ProfileProvider>(
            builder: (context, profileProvider, _) {
              return configModel.loyaltyPointStatus!
                  ? _isLoggedIn
                        ? profileProvider.userInfoModel != null
                              ? SafeArea(
                                  child: Consumer<WalletAndLoyaltyProvider>(
                                    builder: (context, walletProvider, _) => RefreshIndicator(
                                      onRefresh: () async {
                                        walletProvider
                                                                                  ...
                                                                                  children: [
                                                                                    Column(
                                                                                      children: [
                                                                                        ...
                                                                                        walletProvider.transactionList !=
                                                                                                null
