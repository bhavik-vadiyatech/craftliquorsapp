...
class _ConvertMoneyWidgetState extends State<ConvertMoneyWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String?> noteList = [
      ...
      '${Provider.of<SplashProvider>(context, listen: false).configModel!.loyaltyPointExchangeRate} ${getTranslated('point', context)} ${getTranslated('remain', context)} ${PriceConverterHelper.convertPrice(context, 1)}',
