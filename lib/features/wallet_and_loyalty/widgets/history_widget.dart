    ...
    return Container(
      ...
      child: ListTile(
        leading: CircleAvatar(
          ...
          child: Text(
            '${isDebit ? '-' : '+'}${Provider.of<SplashProvider>(context, listen: false).configModel?.currencySymbol}',
            style: poppinsRegular.copyWith(
        ...
        title: CustomDirectionalityWidget(
          child: Text(
            PriceConverterHelper.convertPrice(
              context,
              isDebit ? transaction!.debit : transaction!.credit,
            ),
            overflow: TextOverflow.ellipsis,
            maxLines: 1,
        ...
        trailing: transaction!.createdAt != null
            ? Text(
