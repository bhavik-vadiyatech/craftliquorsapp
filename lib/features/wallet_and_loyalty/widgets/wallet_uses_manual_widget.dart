...
class WalletUsesManualWidget extends StatelessWidget {
  const WalletUsesManualWidget({super.key});

  @override
  Widget build(BuildContext context) {
    final List<String> walletNoteList = Provider.of<WalletAndLoyaltyProvider>(
      context,
      listen: false,
    ).walletNoteList;
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    getTranslated('how_to_use', context),
