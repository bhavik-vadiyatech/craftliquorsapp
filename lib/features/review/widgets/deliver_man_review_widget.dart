                        ...
                        child: Column(
                          children: [
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, i) {
                                  return InkWell(
                                    onTap:
                                        reviewProvider
                                            .deliverymanReviewSubmitted
                                        ? null
                                        : () {
                                            reviewProvider.setDeliveryManRating(
                                              i + 1,
                                            );
                                          },
                                    child: Icon(
                                      reviewProvider.deliveryManRating < (i + 1)
                                          ? Icons.star_border
                                          : Icons.star,
                                      size: 25,
                                      color:
                                          reviewProvider.deliveryManRating <
                                              (i + 1)
                                          ? Theme.of(context)
                                                .textTheme
                                                .bodyLarge
                            ...
                            CustomTextFieldWidget(
                              maxLines: 5,
                              isEnabled:
                                  !reviewProvider.deliverymanReviewSubmitted,
