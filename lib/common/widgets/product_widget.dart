                        ...
                        children: [
                          Stack(
                            children: [
                              ...
                              product.price != discountValue.discount
                                  ? Positioned(
                                      top: 5,
                                      left: 5,
                                      child: DiscountTag(
                              ...
                              Positioned(
                                ...
                                right: 5,
                                bottom: null,
                                child: !isExistInCart || !hasNotVariations
                                    ? Tooltip(
                                              ...
                                              Positioned.fill(
                                                child: Align(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Text(
                                                      '${Provider.of<CartProvider>(context).getCartQuantityByProductId(product.id!)}',
                                                      style: TextStyle(
                                                        color: Theme.of(
                                                          context,
                                                        ).cardColor,
                                                  ...
                                                  onTap: () {
                                                    if (cart
                                                      ...
                                                      if (cart
                                                        ...
                                                        showCustomSnackBarHelper(
                                                          '${getTranslated('there_is_nt_enough_quantity_on_stock', context)} ${getTranslated('only', context)} ${cart.cartList[cardIndex].stock} ${getTranslated('is_available', context)}',
                                                          snackBarStatus:
                                                              SnackBarStatus
                                                                  .info,
                                                        );
                                                      ...
                                                      showCustomSnackBarHelper(
                                                        '${getTranslated('you_cant_add_more_than', context)} ${(cart.cartList[cardIndex].product!.maximumOrderQuantity ?? 0)} '
                                                        '${getTranslated((cart.cartList[cardIndex].product!.maximumOrderQuantity ?? 0) > 1 ? 'items' : 'item', context)}',
                                                        snackBarStatus:
                                                            SnackBarStatus.info,
                                                      );
                                                    }
          ...
          child: Stack(
                        ...
                        product.rating != null
                            ? Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    (product.activeReviewsCount != null &&
                                            product.activeReviewsCount! > 0)
                                        ? '( ${product.activeReviewsCount} )'
                                        : '',
                                    style: poppinsRegular.copyWith(
                                      fontSize: Dimensions.fontSizeSmall,
            ...
            Positioned.fill(
              ...
              child: Align(
                ...
                child: WishButtonWidget(
                  product: product,
                  edgeInset: const EdgeInsets.all(5.0),
                ),
              ),
            ),
                    ...
                    ? Tooltip(
                        ...
                        child: Stack(
                          children: [
                            ...
                            if (isExistInCart && !hasNotVariations)
                              Positioned.fill(
                                child: Align(
                                  alignment: Alignment.topRight,
                                  child: Container(
